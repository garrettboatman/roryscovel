...
const Show = ({ data, setTicketHover }) => {
  ...
  return (
    <div className="bg-[#ebebeb] my-4 md:rounded-xl">
...
const IndexPage = ({ data }) => {
  ...
  return (
    <Layout>
      {/* Main container with relative positioning and aspect ratio */}
      <div className="relative w-full h-[600px] md:h-[800px] lg:h-auto lg:aspect-[2809/1873]">
        {/* Background image container */}
        <div className="absolute left-[-390px] md:left-[-290px] lg:left-[-190px] xl:left-0 w-full min-w-[1000px] sm:min-w-[1200px] md:min-w-[1500px] lg:min-w-[1800px] h-full top-[-64px]">
          <div className="w-full h-full bg-[#ebebeb]">
            <StaticImage
              src="../images/Rory_Scovel_BG.jpg"
        ...
        <div
          id="tickets"
          className=" w-full max-w-[1000px] flex justify-start relative mx-auto"
        >
          <div className="w-full md:min-w-[380px] mx-auto lg:ml-0 md:max-w-[480px] md:px-4 relative top-[400px] md:top-[500px] lg:top-[300px] xl:left-[-100px] z-100">
            <div className="my-8 md:my-0">
              ...
              <div className="bg-[#ebebeb] lg:bg-[#FAFBFD] bg-opacity-98 my-4 md:rounded-xl py-4">
                <div className="flex pt-2 px-5 items-center justify-between">
                  <a
                    href="https://punchup.live/roryscovel/tickets"
                    className={`button standard text-lg mx-auto my-2 px-8 py-3 transition-all hover:scale-[1.2]`}
                  >
                    {"Dates & Tickets"}
                  </a>
                </div>
      ...
      <div className="mt-12 w-full mx-auto md:min-w-[380px] md:max-w-[480px] md:px-4">
        <div
        ...
        <div className="bg-[#ebebeb] mb-4 py-4 md:rounded-xl">
      ...
      <div id="contact" className="my-16 py-5 max-w-[450px] mx-auto">
        <div className="bg-[#ebebeb] md:rounded-lg content-container max-w-lg mx-auto py-6">
