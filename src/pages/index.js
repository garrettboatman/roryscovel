        ...
        <div id="tickets" className="w-full flex justify-start">
          <div className="w-full md:min-w-[380px] md:max-w-[480px] md:px-4">
            <div className="my-8 md:my-0">
              ...
              <div className="relative mt-[-15px] mb-[-30px]">
                <div className="w-full text-center">
              ...
              <div className="bg-[#EED9CF] my-4 md:rounded-xl">
                <div className="flex py-4 px-5 items-center justify-between">
                  <a
                    ...
                    className={`button standard text-lg mx-auto my-4 px-8 py-3 transition-all hover:scale-[1.2]`}
                  >
                    {"Dates & Tickets"}
                  </a>
                </div>
              ...
              <div
                className="relative my-6 mx-6 md:mx-0"
                style={{
                  paddingTop: "56.25%",
                  borderRadius: 15,
                  overflow: "hidden",
