    ...
    items: [
      {
        id: 1,
        renderItem: (
        <div className="flex justify-center w-full px-[8px]"><div>
          <StaticImage
          ...
          <div className="my-8 md:my-2">
            ...
            <div className="bg-[#F1E4CB] my-4 md:rounded-lg relative">
              ...
              <div className="flex py-6 px-5 items-center justify-between">
                ...
                <div><a className="button whatever text-md px-5 py-2 transition-all hover:scale-[1.2]" href="https://www.eventbrite.com/e/an-hour-w-rory-scovel-tickets-492110364347">Tickets</a></div>
              </div>
            </div>

            <div className="relative">
              <div className="w-full text-center">
                <span className="w-[196px] inline-block bold bg-[#03a8e6] border border-[#0087B8] text-[#FFF] px-[15px] py-[3px] rounded-[100px] text-sm font-bold">THE LAST TOUR</span>
              </div>
            </div>
